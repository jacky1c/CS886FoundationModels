...
with open("input/ScienceQA_DATA/problems.json", 'r') as file:
    data = json.load(file)
    
with open("input/ScienceQA_DATA/pid_splits.json") as file:
...
for id in tqdm(train_ids):
    ...
    if train_data['image'] is None:
        continue
    image_url = f"input/scienceqa/images/train/{id}/image.png"
...
for id in tqdm(val_ids):
    ...
    if val_data['image'] is None:
        continue
    image_url = f"input/scienceqa/images/val/{id}/image.png"
...
for id in tqdm(test_ids):
    ...
    if test_data['image'] is None:
        continue
    image_url = f"input/scienceqa/images/test/{id}/image.png"
...
with open("input/scienceqa/scienceqa_train.json", 'x') as file:
    json.dump(train_annotation, file)

with open("input/scienceqa/scienceqa_test.json", 'x') as file:
    json.dump(test_annotation, file)

with open("input/scienceqa/scienceqa_val.json", 'x') as file:
